 ...
 *               $ref: '#/components/schemas/Error'
 *       401:
 *         description: Invalid password or not an admin
 *         content:
 *           application/json:
 *             schema:
 *               $ref: '#/components/schemas/Error'
 ...
 * /api/admin/user/{id}:
 *   put:
 *     summary: Get/Update user information (admin only)
 *     tags: [Admin]
 *     security:
 *       - bearerAuth: []
 *     parameters:
 ...
 *     responses:
 *       200:
 *         description: User information retrieved/updated successfully
 *         content:
 *           application/json:
 *             schema:
 *               type: object
